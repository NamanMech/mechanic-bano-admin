    ...
    <Router>
      ...
      <div style={{ padding: '20px' }}>
        <Routes>
          ...
          {pageStatus.logo && <Route path="/logo" element={<div>Logo Management (Future Page)</div>} />}
          <Route path="/pagecontrol" element={<PageControlManagement refreshPages={fetchPageControl} />} />
        </Routes>
      </div>
    </Router>
  );
