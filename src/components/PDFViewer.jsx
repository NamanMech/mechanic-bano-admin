...
import '../styles/components/pdf-viewer.css';
    ...
    >
      {loading ? (
        ...
        <div className="pdf-error-container">
          ...
          {onClose && (
            <button className="btn-primary pdf-close-btn" onClick={onClose}>
              Close Viewer
            </button>
          )}
        </div>
        ...
        <>
          <div className="pdf-controls">
            ...
            <div className="pdf-zoom-controls">
              <button onClick={zoomOut} className="btn-primary" aria-label="Zoom out" disabled={scale <= 0.5}>-</button>
              <span className="zoom-level">{Math.round(scale * 100)}%</span>
              <button onClick={zoomIn} className="btn-primary" aria-label="Zoom in" disabled={scale >= 3}>+</button>
            </div>
          </div>
          ...
          {totalPages > 0 && (
            <div className="pdf-navigation">
              <button onClick={goToFirstPage} disabled={currentPage === 1} className="btn-primary" aria-label="First page">◀◀</button>
              <button onClick={goToPrevPage} disabled={currentPage === 1} className="btn-primary" aria-label="Previous page">◀ Prev</button>
              ...
              <button onClick={goToNextPage} disabled={currentPage === totalPages} className="btn-primary" aria-label="Next page">Next ▶</button>
              <button onClick={goToLastPage} disabled={currentPage === totalPages} className="btn-primary" aria-label="Last page">▶▶</button>
            </div>
          )}
          <div className="fullscreen-toggle">
            <button onClick={toggleFullScreen} className="btn-primary" aria-label={isFullscreen ? 'Exit fullscreen' : 'Enter fullscreen'}>
