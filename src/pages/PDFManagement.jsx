...
export default function PDFManagement() {
  ...
  // Helper: Remove trailing slash from API URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        embedLink: '', // Assuming embedLink is to be generated later or unused
        category,
            ...
            {pdfs.map((pdf) => (
              ...
              >
                ...
                <div style={{ flexShrink: 0, display: 'flex', gap: '0.5rem' }}>
                  <button type="button" onClick={() => handlePreview(pdf.originalLink)} disabled={loading}>
                    Preview
                  </button>
                  <button type="button" onClick={() => handleEdit(pdf)} disabled={loading}>
                    Edit
                  </button>
                  <button type="button" className="btn-danger" onClick={() => handleDelete(pdf._id)} disabled={loading}>
                    Delete
                  </button>
                </div>
              </li>
